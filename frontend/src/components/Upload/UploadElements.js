...
export const UploadContTop = styled.div`
  height:100%;
  width:100%;
  display: flex;
  justify-content: start;
...
export const UploadContBottom = styled.div`
  height:100%;
  width:auto;
  display: flex;
  justify-content: center;
...
export const FormButtonBrowse = styled.button`
  background: #8a8a8a;
...
export const UploadIcon = styled(FiFolderPlus)`
  margin-left: 8px;
  font-size: 20px;
`;